...
<body>
<div id="header-div">
  <div id="logo-div" style="bgcolor:#000000;"><img src="http://admin.shop.com/Public/images/ecshop_logo.gif" alt="ECSHOP - power for e-commerce" /></div>
  ...
  <div id="submenu-div">
    ...
    <div id="send_info" style="padding: 5px 10px 0 0; clear:right;text-align: right; color: #FF9900;width:40%;float: right;">
        ...
        <div id="load-div" style="padding: 5px 10px 0 0; text-align: right; color: #FF9900; display: none;width:40%;float:right;"><img src="http://admin.shop.com/Public/images/top_loader.gif" width="16" height="16" alt="正在处理您的请求..." style="vertical-align: middle" /> 正在处理您的请求...</div>
  </div>
</div>
<div id="menu-div">
  <ul>
