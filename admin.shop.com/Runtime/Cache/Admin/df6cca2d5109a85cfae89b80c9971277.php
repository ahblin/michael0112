...
.explode {
  background: url(http://admin.shop.com/Public/images/menu_minus.gif) no-repeat 0px 3px;
  font-weight: bold;
}
.collapse {
  background: url(http://admin.shop.com/Public/images/menu_plus.gif) no-repeat 0px 3px;
  font-weight: bold;
}
.menu-item {
  background: url(http://admin.shop.com/Public/images/menu_arrow.gif) no-repeat 0px 3px;
  font-weight: normal;
}
#help-title {
  font-size: 14px;
...
<body>
<div id="tabbar-div">
<p><span style="float:right; padding: 3px 5px;" ><a href="javascript:toggleCollapse();"><img id="toggleImg" src="http://admin.shop.com/Public/images/menu_minus.gif" width="9" height="9" border="0" alt="闭合" /></a></span>
...
<ul id="menu-ul">
  <li class="explode" key="02_cat_and_goods" name="menu">
    商品管理        <ul>
          <li class="menu-item"><a href="<?php echo U('Supplier/index');?>" target="main-frame">供货商列表</a></li>
          <li class="menu-item"><a href="<?php echo U('Goods/goodsList');?>" target="main-frame">商品列表</a></li>
  ...
  <li class="explode" key="10_priv_admin" name="menu">
    权限管理        <ul>
          <li class="menu-item"><a href="privilege.php?act=list" target="main-frame">管理员列表</a></li>
          <li class="menu-item"><a href="admin_logs.php?act=list" target="main-frame">管理员日志</a></li>
          <li class="menu-item"><a href="role.php?act=list" target="main-frame">角色管理</a></li>
