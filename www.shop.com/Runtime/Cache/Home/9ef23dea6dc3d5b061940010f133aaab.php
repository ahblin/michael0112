	...
	<div class="guide w1210 bc mt15">
		...
		<div class="guide_content fl">
			...
			<div class="guide_wrap">
				...
				<div class="crazy">
					<ul>
						<?php if(is_array($is_8s)): $i = 0; $__LIST__ = $is_8s;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><li>
							<dl>
								<dt><a href="<?php echo U('goods',array('id'=>$info['id']));?>"><img src="__GOODS__/<?php echo ($info["logo"]); ?>!m" alt="" /></a></dt>
								<dd><a href="<?php echo U('goods',array('id'=>$info['id']));?>"><?php echo ($info["name"]); ?></a></dd>
								<dd><span>售价：</span><strong> ￥<?php echo ($info["shop_price"]); ?></strong></dd>
							</dl>
				...
				<div class="hot none">
					<ul>
						<?php if(is_array($is_4s)): $i = 0; $__LIST__ = $is_4s;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><li>
							<dl>
								<dt><a href="<?php echo U('goods',array('id'=>$info['id']));?>"><img src="__GOODS__/<?php echo ($info["logo"]); ?>!m" alt="" /></a></dt>
								<dd><a href="<?php echo U('goods',array('id'=>$info['id']));?>"><?php echo ($info["name"]); ?></a></dd>
								<dd><span>售价：</span><strong> ￥<?php echo ($info["shop_price"]); ?></strong></dd>
				...
				<div class="recommend none">
					<ul>
						<?php if(is_array($is_1s)): $i = 0; $__LIST__ = $is_1s;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><li>
								<dl>
									<dt><a href="<?php echo U('goods',array('id'=>$info['id']));?>"><img src="__GOODS__/<?php echo ($info["logo"]); ?>!m" alt="" /></a></dt>
									<dd><a href="<?php echo U('goods',array('id'=>$info['id']));?>"><?php echo ($info["name"]); ?></a></dd>
									<dd><span>售价：</span><strong> ￥<?php echo ($info["shop_price"]); ?></strong></dd>
				...
				<div class="new none">
					<ul>
						<?php if(is_array($is_2s)): $i = 0; $__LIST__ = $is_2s;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><li>
								<dl>
									<dt><a href="<?php echo U('goods',array('id'=>$info['id']));?>"><img src="__GOODS__/<?php echo ($info["logo"]); ?>!m" alt="" /></a></dt>
									<dd><a href="<?php echo U('goods',array('id'=>$info['id']));?>"><?php echo ($info["name"]); ?></a></dd>
									<dd><span>售价：</span><strong> ￥<?php echo ($info["shop_price"]); ?></strong></dd>
				...
				<div class="guess none">
					<ul>
						<?php if(is_array($is_16s)): $i = 0; $__LIST__ = $is_16s;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><li>
								<dl>
									<dt><a href="<?php echo U('goods',array('id'=>$info['id']));?>"><img src="__GOODS__/<?php echo ($info["logo"]); ?>!m" alt="" /></a></dt>
									<dd><a href="<?php echo U('goods',array('id'=>$info['id']));?>"><?php echo ($info["name"]); ?></a></dd>
									<dd><span>售价：</span><strong> ￥<?php echo ($info["shop_price"]); ?></strong></dd>
